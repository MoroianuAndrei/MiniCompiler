...
public class BasicLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"RETURN", "ID", "NUMBER", "STRING_LITERAL", "PLUS", "MINUS", "STAR", 
			"SLASH", "MOD", "LT", "GT", "LE", "GE", "EQ", "NE", "AND", "OR", "NOT", 
	...
	public BasicLanguageLexer(CharStream input) {
		super(input);
